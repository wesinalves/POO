...
- Revisão de conceitos sobre lógica programação. 
- Conceitos fundamentais de programação orientada a objetos: classe, objeto, atributo, método. Abstração, encapsulamento, herança, polimorfismo. 
- Relacionamento entre classes. 
- Tratamento de exceções. 
- Interface gráfica com usuário. 
- Linguagem de programação orientada a objetos de mercado. 
...
- Construir um ou mais projetos práticos que envolvam os conceitos aprendidos em sala de aula que necessariamente abordam interface gráfica e persistência de dados com linguagem de programação orientada a objetos.

# Conteúdo Programático
1. Linguagem de Programação
2. Programação de Computadores
3. Orientação a Objetos: Abstração e Encapsulamento
4. Orientação a Objetos: Herança e Polimorfismo
5. Orientação a Objetos: Classes Abstratas e Interfaces
